  ...
  async up(queryInterface) {
    await queryInterface.bulkInsert('products', [
      ...
      },
      {
        ...
        imageURL: 'products/meat/chicken_breast.webp',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imageURL: 'products/meat/lamb_chop.webp',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
      ...
      },
      {
        ...
        imageURL: 'products/meat/ground_beef.webp',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imageURL: 'products/meat/turkey_breast.webp',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imageURL: 'products/meat/duck_breast.webp',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        imageURL: 'products/meat/veal_chop.webp',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
